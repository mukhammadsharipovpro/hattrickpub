...
import HatTrickCartItemComponent from '../components/HatTrickCartItemComponent';
import HatTrickComponent from '../components/HatTrickComponent';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <HatTrickCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
